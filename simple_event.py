...
class ProgressAsk( object ):
    ...
    def __init__(self, event_dispatcher):
        ...
        self.event_dispatcher.add_event_listener(
            ProgressEvent.RESPOND, self.on_answer_event
        )
    ...
    def ask(self):
        ...
        self.event_dispatcher.dispatch_event(
            ProgressEvent( ProgressEvent.PROGRESS, self )
        )
    ...
    def on_answer_event(self, event):
        ...
        print "<<< Thank you instance {0}".format(event.data.progress)
        

class ProgressRespond( object ):
    """
    ...
    def __init__(self, event_dispatcher):
        ...
        self.event_dispatcher.add_event_listener(
            ProgressEvent.PROGRESS, self.on_ask_event
        )
        self.progress = 0
    ...
    def on_ask_event(self, event):
        ...
        """
        self.event_dispatcher.dispatch_event(
            ProgressEvent ( ProgressEvent.RESPOND, self )
        )
...
if __name__ == "__main__":
    ...
    who_ask = ProgressAsk( dispatcher )
    who_responde1 = ProgressRespond( dispatcher )
    who_responde1.progress = 1
    who_responde2 = ProgressRespond( dispatcher )
    who_responde2.progress = 2
    # WhoAsk ask :-)
    who_ask.ask()
'''